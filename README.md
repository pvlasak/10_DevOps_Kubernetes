...
- configure and start Kubernetes NGINX ingress controller : *minikube addons enable ingress*
- `/etc/hosts` file difnes mapping between the IP address and hostname 
- 
